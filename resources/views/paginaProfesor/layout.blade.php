                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                ...
                                <div id="submenu-1" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="#">Programas Generales</a>
                                        </li>

                                        <li class="nav-item">
                                            <a class="nav-link" href="#">Antivirus</a>
                                        </li>
                                        <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-1-2" aria-controls="submenu-1-2">Isos</a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" ><i class="fa fa-fw fa-rocket"></i>Crear Seccion</a>
                            </li>
                            <li class="nav-item">
